...
/* Unified button style for PDF and YouTube */
.card-body .btn, .card-body .youtube-btn {
    display: inline-flex;
    align-items: center;
    justify-content: center;
...
/* YouTube button */
.card-body a.youtube-btn {
    background: #ff0000;
    color: #fff;
}

.card-body a.youtube-btn:hover {
    background: #cc0000;
    transform: scale(1.05);
    color: #fff;
}
...
<?php endif; ?>
                        ...
                        <div class="card-body">
                            ...
                            <p class="mb-1">
                                ...
                                <?= htmlspecialchars($item['subject_code'] ?? 'N/A') ?>
                            </p>
    ...
    <?php if(!empty($item['pdf'])): ?>
        <a href="uploads/<?php echo htmlspecialchars($item['pdf']); ?>" target="_blank" class="btn btn-sm btn-outline-primary"><i class="fas fa-file-pdf"></i> Open PDF</a>
    <?php endif; ?>
    <?php if(!empty($item['youtube'])): ?>
        <a href="<?= htmlspecialchars($item['youtube']); ?>" target="_blank" class="youtube-btn" title="Watch on YouTube">
